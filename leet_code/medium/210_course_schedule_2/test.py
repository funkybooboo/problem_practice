...
class TestCourseOrder(unittest.TestCase):
    ...
    def test_valid_order_1(self):
        ...
        prerequisites = [[1, 0]]
        expected_output = [0, 1]
        self.assertEqual(Solution().findOrder(num_courses, prerequisites), expected_output)
    ...
    def test_valid_order_2(self):
        ...
        self.assertTrue(Solution().findOrder(num_courses, prerequisites) == expected_output or
                        Solution().findOrder(num_courses, prerequisites) == [0, 2, 1,
                                                                             3])  # Another possible correct order
