...
class TestHammingWeight(unittest.TestCase):
    ...
    def test_example_4(self):
        self.assertEqual(self.solution.hammingWeight(int('00000000000000000000000000010111', 2)), 4)

    def test_example_5(self):
        self.assertEqual(self.solution.hammingWeight(int('01111111111111111111111111111101', 2)), 30)
